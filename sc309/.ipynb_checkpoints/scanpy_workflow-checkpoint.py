...
def filterRegress(SingleCellData):
    ...
    """
    assert(str(type(SingleCellData)) == "<class 'anndata.core.anndata.AnnData'>"), "The data file is not in the correct format" #Makes sure the Data file has been imported correctly
